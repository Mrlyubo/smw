...
class Notification {
    ...
    public function insertNotification($post_id, $user_to, $type) {
        ...
        //printf ($type);
		switch($type) {
			case 'comment'://comment_frame.php
				$message = $userLoggedInName . " commented on your post";//正确
				break;
			case 'like':// like.php
                $message = $userLoggedInName . " liked your post";//正确。
				break;
			case 'profile_post'://Post.php
				$message = $userLoggedInName . " posted on your profile";//正确。
				break;
			case 'comment_non_owner'://comment_frame.php
				$message = $userLoggedInName . " commented on a post you commented on";//变成commented on your post了。
				break;
			case 'profile_comment'://comment_frame.php
				$message = $userLoggedInName . " commented on your profile post";//正确。
				break;
		}
