...
class Message {
    ...
    public function sendMessage($user_to, $body, $date) {
		if($body != "") {
			...
			$query = mysqli_query($this->con, "INSERT INTO messages
                VALUES('', '$user_to', '$userLoggedIn', '$body', '$date', 'no', 'no', 'no')");
		}
	}
    ...
    public function getMessages($otherUser) {
        ...
        $query = mysqli_query($this->con, "UPDATE messages SET opened='yes'
    ...
    public function getLatestMessage($userLoggedIn, $user2) {
    		...
    		$query = mysqli_query($this->con, "SELECT body, user_to, date FROM messages
                WHERE (user_to='$userLoggedIn' AND user_from='$user2') OR (user_to='$user2' AND user_from='$userLoggedIn') ORDER BY id DESC LIMIT 1");
    ...
    public function getConvos() {
        ...
        $query = mysqli_query($this->con, "SELECT user_to, user_from FROM messages
            WHERE user_to='$userLoggedIn' OR user_from='$userLoggedIn' ORDER BY id DESC");
        ...
        foreach($convos as $username) {
            ...
            $return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
                                    <img src='" . $user_found_obj->getProfilePic() . "' margin-right: 5px;'>
    ...
    public function getConvosDropdown($data, $limit) {
        ...
        $page = $data['page'];//comes from smw.js ajax call data (line 43)
        $userLoggedIn = $this->user_obj->getUsername();
        $return_string = "";
        $convos = array();
